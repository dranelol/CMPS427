...
public class ChaosBarrageAbility : Ability
{
    public ChaosBarrageAbility(AttackType attackType, DamageType damageType, float range, float angle, float cooldown, float damageMod, float resourceCost, string id, string readable, GameObject particles)
    ...
    {
        target.GetComponent<EntityAuraManager>().Add("chaosbarrage", source);
