...
public class Whirlwind : Ability
{
    ...
    public IEnumerator DoSpawnAnimation(GameObject source, GameObject particlePrefab, float time, bool isPlayer, float orbitScale, GameObject target = null)
    {
        ...
        particles.GetComponent<OrbSpawnSingle>().yOrbit = true;
        particles.GetComponent<OrbSpawnSingle>().clockwiseRotate = true;
        particles.GetComponent<OrbSpawnSingle>().initialAngleFromForward = 0.0f;
