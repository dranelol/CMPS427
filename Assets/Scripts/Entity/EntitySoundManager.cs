...
public class EntitySoundManager : MonoBehaviour 
{
    ...
    private const float _attackChance = 0.9f;
    private const float _aggroChance = 0.8f;
    private const float _getHitChance = 0.7f;
    private const float _victoryChance = 0.5f;
