...
sealed public class DervishSlow : Aura
{
    ...
    #region Complete
    public DervishSlow(string name)
    ...
    {
        return new DervishSlow(target, caster, prototpe);
    }
    ...
    private DervishSlow(Entity target, Entity caster, Aura prototype) : base(target, caster, prototype) { }
